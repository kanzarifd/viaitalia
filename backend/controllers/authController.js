...
const register = async (req, res) => {
  try {
    // NOTE: `role` is intentionally NOT read from req.body. Public registration
    // always creates a standard USER. Admin accounts are created via createUser
    // (which is protected by authMiddleware + an ADMIN check).
    const { firstName, lastName, email, password, passport, address, phoneNumber, image } = req.body;
